...
clear;
wmod = 'CCMP';
pre = 'Z:\Wind_deltaTF\Wind_Model\CCMP\';
mid = '\CCMP_RT_Wind_Analysis_';
post = '_V02.1_L3.0_RSS.nc';
...
for yr = 2019:2023
    ...
    % site
    site = 'SOCALSN';
    outdir = 'Z:\Wind_deltaTF\Wind_Data\SOCAL';  % Output file directory
    disp([site,' ',year]);
...
%     slat =33.900	;	slon =119.580; %NRS05_14
...
%    slat =  28.00;  slon = 86.994; %GOM NRS06 2016
%       slat = 28.2502; slon = 86.8327; %GOM NRS06 2014
...
%     slat = 41.130;  slon =	66.249;% NRS08_14
% slat = 39.0103;  slon =	67.2706;% NRS08_16
%  slat = 17.785;  slon =	64.65;% NRS12
%slat = 42.404;  slon =	70.130;% NRS09
...
%     slat = 72.450; slon = 156.602; % NRS01

    %HAWAII
    % slat = 17.96308; slon = 145.481117; % Pagan in East Lon
    % slat =	27+ (43.774/60); slon = 175+ (33.221/60); %PHA12
%     slat = -14.269; slon = 170.720; % SAMOA NRS10
%  slat = 22.333; slon = 155.667; % NRS04
    %OCNMS
    %OOI
...
%     slat = 47.765; slon =	125.518; % NRS03
    ...
    disp(['slat= ',num2str(slat),' slon = ',num2str(slon)]);
