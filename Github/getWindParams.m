...
p.harp.harpDataSummaryCSV = 'Y:\MBARC_All\Code\WindCode\HARPdataSummaryWIND.csv';
p.harp.harpDataSummary = readtable(p.harp.harpDataSummaryCSV);
%p.harp.WindFolder = ['W:\Wind_Data\',p.harp.Proj,'\'];
p.harp.WindFolder = ['Y:\Wind_deltaTF\Wind_Data\',p.harp.Proj,'\'];
