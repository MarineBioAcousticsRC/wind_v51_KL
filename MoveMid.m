...
dlet = 'V:'; % Letter for SNOWMAN drive
dlet = 'F:\Shared drives\MBARC_All\Code\LTSA'
global PARAMS
...
if ~iscell(fn_filem)
    ...
    while (exist(fn_pathnew) > 0)
        ...
        copyfile(fnew,fn_path) ; % source destination
...
if tfd <= 300
    ...
    suggestedTFPath = 'F:\Shared drives\MBARC_TF\100-399\320';
else
...
save(fullfile(OutFolder,'WindNoiseMat',OutName),...
    'ptimem','mpwrm','mpwrtfm','freqm') % save all workspace
