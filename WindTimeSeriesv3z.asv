...
wmod = 'CCMP';
drivelet = 'Z';
pre = [drivelet,':\Wind_deltaTF\Wind_Model\CCMP\'];
pre0 = '\v11l30_2004';
mid0 = '\analysis_';
post0 = '_v11l30flk.nc';
...
outpath = 'C:\Users\Kieran Lenssen\Documents\GitHub\KLcode\wind\WindTimeSeries_Results';
%
% wmod = 'ERA5';
...
for yr = 2022 : 2022
    ...
    xlabel(' Month ');
    %save results
    fs = fullfile(outdir,[Proj,site,'windvec_v3z']);
