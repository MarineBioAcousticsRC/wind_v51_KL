...
if strcmp(Proj,'BERING')
    switch site
        case 'M2'
            slat = 56 + (51.620/60); slon =	164 + (03.520/60); %M2 mooring
        case 'M4'
            slat = 57 + (21.648/60); slon = 168 + (52.624/60);%M4 mooring    
    end
end
...
if strcmp(Proj,'GofCA')
    switch site
        case 'T'
            slat = 28 + (36.386/60); slon =	112 + (30.464/60);%Tiburon
        case 'PP'
            slat = 23 + (49.830/60); slon =	109 + (37.870/60);%Punto Pes
        case 'A'
            slat = 23 + (55.580/60); slon =	109 + (40.780/60); %Array
        case 'CB'
            slat = 29 +(01.638/60) ; slon =	113 + (22.539/60); %Canal de Ballenas  
    end
end
