...
%% Make Four Wind vs Noise plots for cleaning data
...
% Create Figures for editing
% C = linspecer(6,'qualitative'); % color map assume 12 max
% figure(1); clf; set(1,'name',sprintf('Wind vs Noise 100Hz')); h1 = gca;
% plot(h1,wsnew(iwind),mpwrtf(ifhun,inoise),'ro'); %use 100Hz noise
...
%
h3 = subplot(2,2,2);
plot(h3,wsnew(iwind),mpwrtf(ifone,inoise),'ro');%use 20 kH
...
if fs0 ==  320000 || fs0 ==  200000 || fs0 == 96000 || ...
    ...
    h4 = subplot(2,2,3);
    plot(h4,wsnew(iwind),mpwrtf(iften,inoise),'ro');%use 20 kH
