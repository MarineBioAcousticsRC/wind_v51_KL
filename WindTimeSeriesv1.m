...
clear;
wmod = 'CCMP';
pre = 'H:\Shared drives\Wind_deltaTF\Wind_Model\CCMP\';
...
for yr = 2019 : 2022
    ...
    Proj = 'SOCAL';
    site = 'N';
    outdir = 'H:\Shared drives\Wind_deltaTF\Wind_Data\SOCAL';  % Output file directory
    disp([Proj,site,' ',year]);
    ...
    [f,mid,post,lat,lon] = CCMP_Variant(pre,year,'01','01',mid1,mid2,post1,post2);
    ...
    for month = 1:12
        ...
        for day = 1:31
            ...
            [f,mid,post,lat,lon] = CCMP_Variant(pre,year,m,d,mid1,mid2,post1,post2);
    ...
    xlabel(' Month ');
    %save results
    fs = fullfile(outdir,year,[Proj,site,'windvec']);
